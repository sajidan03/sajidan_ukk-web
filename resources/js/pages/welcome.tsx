                            ...
                            >
                                ...
                                <div className="p-4">
                                    ...
                                    <a
                                        ...
                                        className="w-full bg-green-500 text-white py-2.5 rounded-lg font-semibold hover:bg-green-600 transition duration-200 flex items-center justify-center gap-2"
                                    >
                            ...
                            >
                                ...
                                <div className="p-4">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className={`w-full py-2.5 rounded-lg font-semibold transition duration-200 flex items-center justify-center gap-2 ${
                                            produk.stok > 0
